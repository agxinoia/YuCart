...
## Features
- **Shopping Cart**: Easily add items to your cart directly from Yupoo.
- **Agent Checkout**: Seamlessly export your cart to Superbuy, Sugargoo, or KakoBuy with one click. (currently only tested with Superbuy)
- **Price Detection**: Automatically detects prices in CNY (¥).
- **Currency Conversion**: Convert prices to your preferred currency.
- **AI Cart Name Cleaning**: Use AI to clean up product names for better readability.
...
2. Load the extension in your browser's extension manager.

## To-Do List
- [ ] Add support for more agents.
- [x] Add a checkout option that adds all the products to your selected agent.
